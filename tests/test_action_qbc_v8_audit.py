...
P8_COMMIT = "61cebe90a2f4f7c78ec45119de53a482ed13a655"
P8_DOCUMENT_GIT_BLOB_SHA1 = "5e870ed0bbbff6fcb4352f6e914d870254773f68"
P8_DOCUMENT_SHA256 = (
...
V8_AUDIT_GIT_BLOB_SHA1 = "cf851c9041c56d4a24abda3def1e8a4f78642496"
V8_AUDIT_SHA256 = (
    "9d60cb805ddb49f10ca21a02225a9434786c24152d03054feafefb85de12256a"
)
V8_AUDIT_BYTE_COUNT = 180_248
...
def test_v8_identity_constants_are_truthful_and_scientific_names_stay_frozen() -> None:
    ...
    assert audit.OPEN_FREEZE_TAG == "action-qbc-v8-open-diagnostic-freeze-v3"
