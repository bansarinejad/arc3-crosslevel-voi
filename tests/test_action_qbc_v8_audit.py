...
P8_DOCUMENT_PATH = (
    ...
    / "docs"
    / (
        "experiment_amendment_2026-08-11_"
...
P8_COMMIT = "e0bff9ffc185196cafa938c8f7c9a7186366258b"
P8_DOCUMENT_GIT_BLOB_SHA1 = "29c991b7e23209f2c38d5e9a11a15bca51753d8e"
P8_DOCUMENT_SHA256 = (
...
V8_AUDIT_GIT_BLOB_SHA1 = "c98297e729c27d6ff6ef866280a311cab7585a50"
V8_AUDIT_SHA256 = (
    "130dcc271799f035b571e30cc41304c2c3046ddf866eb80b3bbe4b0428c21444"
)
V8_AUDIT_BYTE_COUNT = 180_230
...
def test_v8_identity_constants_are_truthful_and_scientific_names_stay_frozen() -> None:
    ...
    assert audit.OPEN_FREEZE_TAG == "action-qbc-v8-open-diagnostic-freeze-v1"
