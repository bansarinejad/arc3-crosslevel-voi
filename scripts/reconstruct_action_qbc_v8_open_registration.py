...
PREREGISTRATION_TAG: Final = "prereg-action-qbc-v8-open-bounded-remote-verification-v7"
PREREGISTRATION_COMMIT: Final = "15059c482d9e463f01cb31fdfd33c96d1f60db0a"
PREREGISTRATION_TREE: Final = "96469ca9ee018cd32f99955df1ded57af12a8abc"
PREREGISTRATION_DOCUMENT: Final = (
    "docs/experiment_amendment_2026-08-18_"
    "action_qbc_v8_open_bounded_remote_verification_v7_consumed_lifecycle_recovery.md"
)
PREREGISTRATION_DOCUMENT_BLOB: Final = "c0cda2417bd98a42b76e8e1bbdee4cec01dd68f9"
PREREGISTRATION_DOCUMENT_SHA256: Final = (
    "f729904367dd7a2664ecd3fdfe4893841326668fbe892b3b733926ad7840745d"
)
PREREGISTRATION_DOCUMENT_BYTE_COUNT: Final = 37_552

PREREGISTRATION_V6_TAG: Final = "prereg-action-qbc-v8-open-bounded-remote-verification-v6"
PREREGISTRATION_V6_COMMIT: Final = "61cebe90a2f4f7c78ec45119de53a482ed13a655"
PREREGISTRATION_V6_TREE: Final = "65695876c44eeb8cac5437149384071f88ff6018"
PREREGISTRATION_V6_DOCUMENT: Final = (
    "docs/experiment_amendment_2026-08-18_"
    "action_qbc_v8_open_bounded_remote_verification_v6_runner_manifest_key_recovery.md"
)
PREREGISTRATION_V6_DOCUMENT_BLOB: Final = "5e870ed0bbbff6fcb4352f6e914d870254773f68"
PREREGISTRATION_V6_DOCUMENT_SHA256: Final = (
    "0ba4cc55ca2b31433bc458972ffc32d87f84b610673fa22ed2b4dd4a8bfc1a41"
)
PREREGISTRATION_V6_DOCUMENT_BYTE_COUNT: Final = 32_370

PREREGISTRATION_V5_TAG: Final = "prereg-action-qbc-v8-open-bounded-remote-verification-v5"
PREREGISTRATION_V5_COMMIT: Final = "09f9caea346866a1acf35c20e0c9d937096b5ce3"
PREREGISTRATION_V5_TREE: Final = "47a978cdd887fd6dc1cb5e80e36aa3e0a5a29253"
PREREGISTRATION_V5_DOCUMENT: Final = (
    "docs/experiment_amendment_2026-08-18_"
    "action_qbc_v8_open_bounded_remote_verification_v5_public_visibility_recovery.md"
)
PREREGISTRATION_V5_DOCUMENT_BLOB: Final = "7c0955a775af89dcfcde4796a9bbb4d470669d10"
PREREGISTRATION_V5_DOCUMENT_SHA256: Final = (
    "cc9d787a64700332a44f543e7a949ee5522c3663b6b0eb54e418840e560cfe6d"
)
PREREGISTRATION_V5_DOCUMENT_BYTE_COUNT: Final = 25_872

PREREGISTRATION_V4_TAG: Final = "prereg-action-qbc-v8-open-bounded-remote-verification-v4"
PREREGISTRATION_V4_COMMIT: Final = "e0bff9ffc185196cafa938c8f7c9a7186366258b"
PREREGISTRATION_V4_DOCUMENT: Final = (
    "docs/experiment_amendment_2026-08-11_"
    "action_qbc_v8_open_bounded_remote_verification_v4_correction.md"
)
PREREGISTRATION_V4_DOCUMENT_BLOB: Final = "29c991b7e23209f2c38d5e9a11a15bca51753d8e"
PREREGISTRATION_V4_DOCUMENT_SHA256: Final = (
    "31d6a04b113e5f18621c3b27af69d9e7d3a19289047673719ccd149d33b5b7b1"
)
PREREGISTRATION_V4_DOCUMENT_BYTE_COUNT: Final = 33_215
...
OPEN_FREEZE_V1_COMMIT: Final = "7685fbdccd41702216b3a3f06d2a0ac699aca7ec"
OPEN_FREEZE_V1_TAG: Final = "action-qbc-v8-open-diagnostic-freeze-v1"
OPEN_FREEZE_V1_TREE: Final = "9b9ad5ba986afacbcdb1fde3cd69e0f1c94efdf2"
OPEN_FREEZE_V2_COMMIT: Final = "8da637a47de0c88f917f222e52e54b342d729be9"
OPEN_FREEZE_V2_TAG: Final = "action-qbc-v8-open-diagnostic-freeze-v2"
OPEN_FREEZE_V2_TREE: Final = "247eba59e1e2ac9b0611c0e361de945dae0f2dc8"
OPEN_FREEZE_V3_COMMIT: Final = "5725395a850627fae10e8bb8b27083ccf63b6ec7"
OPEN_FREEZE_V3_TAG: Final = "action-qbc-v8-open-diagnostic-freeze-v3"
OPEN_FREEZE_V3_TREE: Final = "7d38de8f5cec16cab92c9d3b757a218e8e490272"
OPEN_FREEZE_TAG: Final = "action-qbc-v8-open-diagnostic-freeze-v4"
RESULT_TAG: Final = "action-qbc-v8-open-diagnostic-result-v4"
...
def _expected_name_status(paths: Sequence[str]) -> bytes:
    return _expected_typed_name_status(("A", path) for path in paths)


def _expected_typed_name_status(rows: Iterable[tuple[str, str]]) -> bytes:
    ordered = sorted(rows, key=lambda row: row[1].encode("utf-8"))
    if any(code not in {"A", "D", "M"} for code, _path in ordered):
        raise ReconstructionError("internal name-status expectation has an invalid code")
    return b"".join(
        code.encode("ascii") + b"\0" + path.encode("utf-8") + b"\0"
...
def _resolve_phase(root: Path) -> tuple[str, str, list[tuple[str, str, str, int | None]]]:
    ...
    _tag_commit(
        root,
        PREREGISTRATION_V4_TAG,
        PREREGISTRATION_V4_COMMIT,
        "superseded preregistration v4",
    )
    _tag_commit(
        root,
        OPEN_FREEZE_V1_TAG,
        OPEN_FREEZE_V1_COMMIT,
        "historical open-freeze v1",
    )
    _tag_commit(
        root,
        PREREGISTRATION_V5_TAG,
        PREREGISTRATION_V5_COMMIT,
        "historical preregistration v5",
    )
    _tag_commit(
        root,
        OPEN_FREEZE_V2_TAG,
        OPEN_FREEZE_V2_COMMIT,
        "historical open-freeze v2",
    )
    _tag_commit(
        root,
        PREREGISTRATION_V6_TAG,
        PREREGISTRATION_V6_COMMIT,
        "historical preregistration v6",
    )
    _tag_commit(
        root,
        OPEN_FREEZE_V3_TAG,
        OPEN_FREEZE_V3_COMMIT,
        "historical open-freeze v3",
    )
    ...
    v4_expected_addition = b"A\0" + PREREGISTRATION_V4_DOCUMENT.encode("utf-8") + b"\0"
    ...
    v4_entry, v4_raw = _blob_at(
        root,
        PREREGISTRATION_V4_COMMIT,
        PREREGISTRATION_V4_DOCUMENT,
    )
    if (
        v4_entry.get("git_blob_sha1") != PREREGISTRATION_V4_DOCUMENT_BLOB
        or hashlib.sha256(v4_raw).hexdigest() != PREREGISTRATION_V4_DOCUMENT_SHA256
        or len(v4_raw) != PREREGISTRATION_V4_DOCUMENT_BYTE_COUNT
    ):
    ...
    if o8_v1_delta != _expected_name_status(ALL_ADDITIONS):
        raise ReconstructionError("P8v4..O8v1 is not the exact fifteen-addition allowlist")
    o8_v1_tree = _git(
        root, "rev-parse", f"{OPEN_FREEZE_V1_COMMIT}^{{tree}}"
    ).decode("ascii").strip()
    if o8_v1_tree != OPEN_FREEZE_V1_TREE:
        raise ReconstructionError("historical O8v1 tree identity differs")
    _require_direct_child(root, PREREGISTRATION_V5_COMMIT, OPEN_FREEZE_V1_COMMIT, "P8v5")
    p8_v5_delta = _git(
        root,
        "diff",
        "--name-status",
    ...
    expected_p8_v5_delta = _expected_typed_name_status(
        [*(("D", path) for path in ALL_ADDITIONS), ("A", PREREGISTRATION_V5_DOCUMENT)]
    )
    if p8_v5_delta != expected_p8_v5_delta:
        raise ReconstructionError("O8v1..P8v5 is not the exact fifteen-deletion/one-addition reset")
    p8_v5_entry, p8_v5_raw = _blob_at(
        root,
        PREREGISTRATION_V5_COMMIT,
        PREREGISTRATION_V5_DOCUMENT,
    )
    if (
        p8_v5_entry.get("mode") != "100644"
        or p8_v5_entry.get("git_blob_sha1") != PREREGISTRATION_V5_DOCUMENT_BLOB
        or hashlib.sha256(p8_v5_raw).hexdigest() != PREREGISTRATION_V5_DOCUMENT_SHA256
        or len(p8_v5_raw) != PREREGISTRATION_V5_DOCUMENT_BYTE_COUNT
    ):
        raise ReconstructionError("P8v5 document identity differs from the frozen recovery")
    p8_v4_tree = _tree_entries(root, PREREGISTRATION_V4_COMMIT)
    p8_v5_tree = _tree_entries(root, PREREGISTRATION_V5_COMMIT)
    p8_v5_document_entry = next(
        (entry for entry in p8_v5_tree if entry[0] == PREREGISTRATION_V5_DOCUMENT),
        None,
    )
    if p8_v5_document_entry is None:
        raise ReconstructionError("P8v5 recovery document is absent from its tree")
    expected_p8_v5_tree = sorted(
        [*p8_v4_tree, p8_v5_document_entry],
        key=lambda entry: entry[0].encode("utf-8"),
    )
    if p8_v5_tree != expected_p8_v5_tree:
        raise ReconstructionError("P8v5 tree is not exactly P8v4 plus the recovery document")
    p8_v5_tree_sha = _git(
        root, "rev-parse", f"{PREREGISTRATION_V5_COMMIT}^{{tree}}"
    ).decode("ascii").strip()
    if p8_v5_tree_sha != PREREGISTRATION_V5_TREE:
        raise ReconstructionError("historical P8v5 tree identity differs")
    _require_direct_child(root, OPEN_FREEZE_V2_COMMIT, PREREGISTRATION_V5_COMMIT, "O8v2")
    o8_v2_delta = _git(
        root,
        "diff",
        "--name-status",
    ...
    if o8_v2_delta != _expected_name_status(ALL_ADDITIONS):
        raise ReconstructionError("P8v5..O8v2 is not the exact fifteen-addition allowlist")
    o8_v2_tree = _git(
        root, "rev-parse", f"{OPEN_FREEZE_V2_COMMIT}^{{tree}}"
    ).decode("ascii").strip()
    if o8_v2_tree != OPEN_FREEZE_V2_TREE:
        raise ReconstructionError("historical O8v2 tree identity differs")
    _require_direct_child(
        root,
        PREREGISTRATION_V6_COMMIT,
        OPEN_FREEZE_V2_COMMIT,
    ...
    expected_p8_v6_delta = _expected_typed_name_status(
        [
            *(("D", path) for path in ALL_ADDITIONS),
            ("A", PREREGISTRATION_V6_DOCUMENT),
        ]
    )
    if p8_v6_delta != expected_p8_v6_delta:
        raise ReconstructionError("O8v2..P8v6 is not the exact fifteen-deletion/one-addition reset")
    p8_v6_entry, p8_v6_raw = _blob_at(
        root,
        PREREGISTRATION_V6_COMMIT,
        PREREGISTRATION_V6_DOCUMENT,
    )
    if (
        p8_v6_entry.get("mode") != "100644"
        or p8_v6_entry.get("git_blob_sha1") != PREREGISTRATION_V6_DOCUMENT_BLOB
        or hashlib.sha256(p8_v6_raw).hexdigest()
        != PREREGISTRATION_V6_DOCUMENT_SHA256
        or len(p8_v6_raw) != PREREGISTRATION_V6_DOCUMENT_BYTE_COUNT
    ):
        raise ReconstructionError("P8v6 document identity differs from the frozen recovery")
    p8_v5_to_v6 = _git(
        root,
        "diff",
        "--name-status",
    ...
    expected_p8_v6_net_addition = (
        b"A\0" + PREREGISTRATION_V6_DOCUMENT.encode("utf-8") + b"\0"
    )
    if p8_v5_to_v6 != expected_p8_v6_net_addition:
        raise ReconstructionError("P8v5..P8v6 is not the one-document net addition")
    p8_v6_tree = _tree_entries(root, PREREGISTRATION_V6_COMMIT)
    p8_v6_document_entry = next(
        (entry for entry in p8_v6_tree if entry[0] == PREREGISTRATION_V6_DOCUMENT),
        None,
    )
    if p8_v6_document_entry is None:
        raise ReconstructionError("P8v6 recovery document is absent from its tree")
    expected_p8_v6_tree = sorted(
        [*p8_v5_tree, p8_v6_document_entry],
        key=lambda entry: entry[0].encode("utf-8"),
    )
    if p8_v6_tree != expected_p8_v6_tree:
        raise ReconstructionError("P8v6 tree is not exactly P8v5 plus the recovery document")
    p8_v6_tree_sha = _git(
        root, "rev-parse", f"{PREREGISTRATION_V6_COMMIT}^{{tree}}"
    ).decode("ascii").strip()
    if p8_v6_tree_sha != PREREGISTRATION_V6_TREE:
        raise ReconstructionError("P8v6 tree identity differs")
    _require_direct_child(
        root,
        OPEN_FREEZE_V3_COMMIT,
        PREREGISTRATION_V6_COMMIT,
    ...
    if o8_v3_delta != _expected_name_status(ALL_ADDITIONS):
        raise ReconstructionError("P8v6..O8v3 is not the exact fifteen-addition allowlist")
    o8_v3_tree = _git(
        root, "rev-parse", f"{OPEN_FREEZE_V3_COMMIT}^{{tree}}"
    ).decode("ascii").strip()
    if o8_v3_tree != OPEN_FREEZE_V3_TREE:
        raise ReconstructionError("historical O8v3 tree identity differs")
    _require_direct_child(
        root,
    ...
    expected_p8_v7_delta = _expected_typed_name_status(
        [*(("D", path) for path in ALL_ADDITIONS), ("A", PREREGISTRATION_DOCUMENT)]
    )
    if p8_v7_delta != expected_p8_v7_delta:
        raise ReconstructionError("O8v3..P8v7 is not the exact fifteen-deletion/one-addition reset")
    p8_v7_entry, p8_v7_raw = _blob_at(
        root,
        PREREGISTRATION_COMMIT,
        PREREGISTRATION_DOCUMENT,
    )
    if (
        p8_v7_entry.get("mode") != "100644"
        or p8_v7_entry.get("git_blob_sha1") != PREREGISTRATION_DOCUMENT_BLOB
        or hashlib.sha256(p8_v7_raw).hexdigest() != PREREGISTRATION_DOCUMENT_SHA256
        or len(p8_v7_raw) != PREREGISTRATION_DOCUMENT_BYTE_COUNT
    ):
        raise ReconstructionError("P8v7 document identity differs from the frozen recovery")
    p8_v6_to_v7 = _git(
        root,
        "diff",
        "--name-status",
    ...
    expected_p8_v7_net_addition = (
        b"A\0" + PREREGISTRATION_DOCUMENT.encode("utf-8") + b"\0"
    )
    if p8_v6_to_v7 != expected_p8_v7_net_addition:
        raise ReconstructionError("P8v6..P8v7 is not the one-document net addition")
    p8_v7_tree = _tree_entries(root, PREREGISTRATION_COMMIT)
    p8_v7_document_entry = next(
        (entry for entry in p8_v7_tree if entry[0] == PREREGISTRATION_DOCUMENT),
        None,
    )
    if p8_v7_document_entry is None:
        raise ReconstructionError("P8v7 recovery document is absent from its tree")
    expected_p8_v7_tree = sorted(
        [*p8_v6_tree, p8_v7_document_entry],
        key=lambda entry: entry[0].encode("utf-8"),
    )
    if p8_v7_tree != expected_p8_v7_tree or len(p8_v7_tree) != 233:
        raise ReconstructionError("P8v7 tree is not exactly P8v6 plus the recovery document")
    p8_v7_tree_sha = _git(
        root, "rev-parse", f"{PREREGISTRATION_COMMIT}^{{tree}}"
    ).decode("ascii").strip()
    if p8_v7_tree_sha != PREREGISTRATION_TREE:
        raise ReconstructionError("P8v7 tree identity differs")
    head = _git(root, "rev-parse", "HEAD").decode("ascii").strip()
    _hex(head, 40, "HEAD")
    if head == PREREGISTRATION_COMMIT:
        if _git(root, "diff", "--name-status", "--no-renames", "-z") != b"":
            raise ReconstructionError("pre-O8v4 worktree has filtered changes to staged/tracked bytes")
        cached = _git(
        ...
        if cached not in {
            ...
            raise ReconstructionError("pre-O8v4 index is not the exact fourteen- or fifteen-addition allowlist")
        ...
        for record in status.split(b"\0"):
            ...
            if len(record) < 4 or record[2:3] != b" ":
                raise ReconstructionError("malformed pre-O8v4 Git status")
            code = record[:2]
            path = record[3:].decode("utf-8")
            if path not in allowed or code not in {b"A ", b"??"}:
                raise ReconstructionError(f"non-allowlisted pre-O8v4 state: {code!r} {path}")
            seen.add(path)
        if not set(NON_REGISTRATION_ADDITIONS) <= seen:
            raise ReconstructionError("pre-O8v4 status lacks one of the fourteen staged additions")
    ...
    _require_direct_child(root, head, PREREGISTRATION_COMMIT, "O8v4")
    delta = _git(root, "diff", "--name-status", "--no-renames", "-z", PREREGISTRATION_COMMIT, head)
    if delta != _expected_name_status(ALL_ADDITIONS):
        raise ReconstructionError("P8v7..O8v4 is not the exact fifteen-addition allowlist")
    _tag_commit(root, OPEN_FREEZE_TAG, head, "open-freeze")
    index = _index_entries(root)
    tree = _tree_entries(root, head)
    if len(tree) != 248:
        raise ReconstructionError("O8v4 tree does not contain exactly 248 entries")
    if [(p, m, o) for p, m, o, _ in index] != [(p, m, o) for p, m, o, _ in tree]:
        raise ReconstructionError("clean O8v4 stage-zero index differs from its tree")
...
def _execution_contract(added_manifest: Sequence[Mapping[str, object]]) -> dict[str, object]:
    root = "/var/tmp/arc3-crosslevel-voi-action-qbc-v8-open-v4"
    ...
    win_claim = r"D:\kaggle competitions\arc3-crosslevel-voi-action-qbc-v8-remote-verification-claim-v4.json"
    win_verifier_claim = r"D:\kaggle competitions\arc3-crosslevel-voi-action-qbc-v8-remote-verifier-start-claim-v4.json"
    win_receipt = r"D:\kaggle competitions\arc3-crosslevel-voi-action-qbc-v8-remote-verification-v4.json"
    win_supervisor_receipt = r"D:\kaggle competitions\arc3-crosslevel-voi-action-qbc-v8-remote-verification-supervisor-v4.json"
    linux_claim = "/mnt/d/kaggle competitions/arc3-crosslevel-voi-action-qbc-v8-remote-verification-claim-v4.json"
    linux_verifier_claim = "/mnt/d/kaggle competitions/arc3-crosslevel-voi-action-qbc-v8-remote-verifier-start-claim-v4.json"
    linux_receipt = "/mnt/d/kaggle competitions/arc3-crosslevel-voi-action-qbc-v8-remote-verification-v4.json"
    linux_supervisor_receipt = "/mnt/d/kaggle competitions/arc3-crosslevel-voi-action-qbc-v8-remote-verification-supervisor-v4.json"
    ...
    contract = {
        ...
        "linux_tool_identities": [
            ...
            {"path": "/usr/bin/git", "version": "2.43.0", "sha256": "2a8c18fbf43da9f692d75474c72bea9dfd796c260b0f3dfe456376abc3bbd668"},
...
def _expected_authority_identities(
    ...
    append("raw_audit", ["cat-file", "-t", f"refs/tags/{PREREGISTRATION_V4_TAG}"])
    append("raw_audit", ["rev-parse", f"refs/tags/{PREREGISTRATION_V4_TAG}"])
    append("raw_audit", ["rev-list", "--parents", "-n", "1", PREREGISTRATION_V4_COMMIT])
    append(
        "raw_audit",
        [
            "diff", "--name-status", "--no-renames", "-z",
            PREREGISTRATION_V3_COMMIT, PREREGISTRATION_V4_COMMIT,
        ],
    )
    append("raw_audit", ["cat-file", "-t", f"refs/tags/{OPEN_FREEZE_V1_TAG}"])
    append("raw_audit", ["rev-parse", f"refs/tags/{OPEN_FREEZE_V1_TAG}"])
    append("raw_audit", ["rev-list", "--parents", "-n", "1", OPEN_FREEZE_V1_COMMIT])
    append(
        "raw_audit",
        [
            "diff", "--name-status", "--no-renames", "-z",
            PREREGISTRATION_V4_COMMIT, OPEN_FREEZE_V1_COMMIT,
        ],
    )
    append("raw_audit", ["cat-file", "-t", f"refs/tags/{PREREGISTRATION_V5_TAG}"])
    append("raw_audit", ["rev-parse", f"refs/tags/{PREREGISTRATION_V5_TAG}"])
    append("raw_audit", ["rev-list", "--parents", "-n", "1", PREREGISTRATION_V5_COMMIT])
    append(
        "raw_audit",
        [
            "diff", "--name-status", "--no-renames", "-z",
            OPEN_FREEZE_V1_COMMIT, PREREGISTRATION_V5_COMMIT,
        ],
    )
    append("raw_audit", ["cat-file", "-t", f"refs/tags/{OPEN_FREEZE_V2_TAG}"])
    append("raw_audit", ["rev-parse", f"refs/tags/{OPEN_FREEZE_V2_TAG}"])
    append("raw_audit", ["rev-list", "--parents", "-n", "1", OPEN_FREEZE_V2_COMMIT])
    append(
        "raw_audit",
        [
            "diff", "--name-status", "--no-renames", "-z",
            PREREGISTRATION_V5_COMMIT, OPEN_FREEZE_V2_COMMIT,
        ],
    )
    append("raw_audit", ["cat-file", "-t", f"refs/tags/{PREREGISTRATION_V6_TAG}"])
    append("raw_audit", ["rev-parse", f"refs/tags/{PREREGISTRATION_V6_TAG}"])
    append("raw_audit", ["rev-list", "--parents", "-n", "1", PREREGISTRATION_V6_COMMIT])
    append(
        "raw_audit",
        [
            "diff", "--name-status", "--no-renames", "-z",
            OPEN_FREEZE_V2_COMMIT, PREREGISTRATION_V6_COMMIT,
        ],
    )
    append("raw_audit", ["cat-file", "-t", f"refs/tags/{OPEN_FREEZE_V3_TAG}"])
    append("raw_audit", ["rev-parse", f"refs/tags/{OPEN_FREEZE_V3_TAG}"])
    append("raw_audit", ["rev-list", "--parents", "-n", "1", OPEN_FREEZE_V3_COMMIT])
    append(
        "raw_audit",
        [
            "diff", "--name-status", "--no-renames", "-z",
            PREREGISTRATION_V6_COMMIT, OPEN_FREEZE_V3_COMMIT,
        ],
    )
    ...
    append(
        ...
        [
            "diff", "--name-status", "--no-renames", "-z",
            OPEN_FREEZE_V3_COMMIT, PREREGISTRATION_COMMIT,
        ],
    )
    append(
        "raw_audit",
    ...
    if len(commands) != 54:
        raise ReconstructionError("internal authority command plan is not 54 rows")
    return [
        _command_identity(
            attempt_index=None,
            label="authority",
