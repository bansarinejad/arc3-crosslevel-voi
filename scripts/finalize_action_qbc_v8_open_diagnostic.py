...
_OPEN_FREEZE_TAG = "action-qbc-v8-open-diagnostic-freeze-v1"
_PREREGISTRATION_TAG = "prereg-action-qbc-v8-open-bounded-remote-verification-v4"
_PREREGISTRATION_COMMIT = "e0bff9ffc185196cafa938c8f7c9a7186366258b"
...
_PREREGISTRATION_DOCUMENT_BLOB = "29c991b7e23209f2c38d5e9a11a15bca51753d8e"
_PREREGISTRATION_DOCUMENT_SHA256 = (
    "31d6a04b113e5f18621c3b27af69d9e7d3a19289047673719ccd149d33b5b7b1"
)
_PREREGISTRATION_DOCUMENT_BYTE_COUNT = 33_215
...
def _repository_and_registration(root: Path) -> tuple[str, dict[str, Any], bytes]:
    ...
    for commit_id, path, blob, digest, count, name in (
        ...
        (
            _PREREGISTRATION_COMMIT, _PREREGISTRATION_DOCUMENT,
            _PREREGISTRATION_DOCUMENT_BLOB, _PREREGISTRATION_DOCUMENT_SHA256,
            _PREREGISTRATION_DOCUMENT_BYTE_COUNT, "P8v4",
        ),
    ):
