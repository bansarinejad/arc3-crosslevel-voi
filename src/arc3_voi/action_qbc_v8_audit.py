...
REGISTRATION_SCHEMA_VERSION: Final = "action-qbc-v8-open-registration-v1"
SCIENTIFIC_SCHEMA_VERSION: Final = "action-qbc-v8-open-diagnostic-payload-v1"
...
def _registration_file_sha256(repository_root: Path, registration: Mapping[str, JsonValue]) -> str:
    ...
    path_value: object = "artifacts/action_qbc_v8_open_registration.json"
    if isinstance(execution, Mapping):
        ...
        path_value = "artifacts/action_qbc_v8_open_registration.json"
